      ...
      <b-col md="12">
        <b-card>
          ...
          <b-form @submit.prevent="salesman" >
            <!-- form starts -->
            <b-form-group
            label="ERP ID del vendedor (opcional)"
            label-for="salesmanId"
            label-cols-lg="3"
            >
            <b-form-input id="basicName" type="text"  v-model="form.salesman.relation_id" placeholder="0000001"></b-form-input>           
          </b-form-group>
          ...
          <b-form-group
                  ...
                  label-cols-lg="3"
                  >
            <b-form-input id="basicName" type="text"  v-model="form.salesman.name" placeholder="Ingresa nombre del vendedor"></b-form-input>
          </b-form-group>
          ...
          <b-form-group
            ...
            <!-- form ends -->
          <!-- <Fields :salesman="form.salesman" :options="options" :selection="selected_salesman"></Fields> -->
          <!-- <Fields :salesman="form.salesman"></Fields> -->
...
export default {
  ...
  methods: {
    ...
    async salesman () {
        ...
        await this.$axios.post('salesman',data)
         .then(response => {        
        // JSON responses are automatically parsed.
