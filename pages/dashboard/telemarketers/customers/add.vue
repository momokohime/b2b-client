      ...
      <b-col md="12">
        <b-card>
          ...
          <b-form-group
            ...
            label-cols-lg="3"
            >
            <b-form-input id="basicName" type="text"  placeholder="Ingresa nombre"></b-form-input>
          </b-form-group>
          <b-form-group
            label="Email"
            ...
            label-cols-lg="3"
            >
            <b-form-input id="basicEmail" type="email" placeholder="Ingresa e-mail"></b-form-input>
          </b-form-group>
          <b-form-group
            label="Contraseña"
            ...
            label-cols-lg="3"
            >
            <b-form-input id="basicPassword" type="password" placeholder="Ingresa contraseña"></b-form-input>
          </b-form-group>
          ...
          <b-form-group
            ...
            label-cols-lg="3"
            >
            <b-form-input id="basicPhone" type="text" placeholder="Ingresa número"></b-form-input>
          </b-form-group>
           <b-form-group
            label="Status"
