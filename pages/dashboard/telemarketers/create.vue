  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col md="12">
        <b-card>
          <div slot="header">
            <strong>Agregar Telemarketing</strong>
          </div>
          ...
          <b-form @submit.prevent="salesman" >
            <!-- form starts -->
            <b-form-group
            label="ERP ID del Telemarketing (opcional)"
          ...
          <b-form-group
                  ...
                  label-cols-lg="3"
                  >
            <b-form-input id="basicName" type="text"  v-model="form.salesman.name" placeholder="Ingresa nombre del Telemarketing"></b-form-input>
          </b-form-group>
...
export default {
  ...
  methods: {
    ...
    async salesman () {
        ...
        await this.$axios.post('telemarketers',data)
         .then(response => {        
        // JSON responses are automatically parsed.
